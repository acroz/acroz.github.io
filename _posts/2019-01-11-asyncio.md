...
coroutine-based concurrency programming model. We therefore used
[aiohttp][aiohttp], a popular HTTP library built on top of asyncio, to send
monitoring information back to our tracking service.

To make a request with aiohttp:
